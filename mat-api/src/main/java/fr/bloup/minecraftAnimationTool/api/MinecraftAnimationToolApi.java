...
public interface MinecraftAnimationToolApi {
    ...
    /**
     * Spawns a rigged model with a uniform scale (1.0 = normal). The name is made unique.
     * Returns the handle, or null if the cache or location is invalid.
     */
    AnimatedModel spawn(String name, String cacheName, Location location, float scale);
