...
public class HelpSubCommand implements TabExecutor {
    ...
    private static final List<String> LINES = List.of(
            ...
            "§e/mat spawn <name> <cache> [scale] §7- spawn a model",
            "§e/mat list §7- list spawned models",
            "§e/mat info <name> §7- show info about a model",
            "§e/mat play <name> <animation> §7- play an animation (cross-fades)",
            "§e/mat pose <name> <animation> <time> §7- freeze on one frame (seconds)",
            "§e/mat pause <name> §7- pause the current animation",
            "§e/mat resume <name> §7- resume a paused animation",
